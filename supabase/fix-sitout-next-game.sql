-- Ensure a one-game sit-out becomes eligible as soon as that skipped game ends.
-- Replaces the multi-court game advancement function without changing its API.
