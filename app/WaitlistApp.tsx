...
export default function App() {
  ...
  function confirmAdminLeave(player:Player){ask(`Remove ${player.display_name}?`,`${player.display_name} will leave the current game or waitlist. The admin can undo this action.`,'Leave',async()=>{await rpc('admin_leave_player',{p_player_id:player.id})})}
