...
export default function App() {
  ...
  const [courtCountEditing,setCourtCountEditing]=useState(false);
  ...
  useEffect(()=>{if(!courtCountEditing)setCourtCountDraft(String(config.court_count))},[config.court_count,courtCountEditing]);
