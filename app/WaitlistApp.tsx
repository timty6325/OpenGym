...
export default function App() {
  ...
  function confirmJoinKingTeam(team:KingTeam){
    if(!me||team.id===me.team_id)return;
    setNotice({title:`Join ${team.name}?`,message:'Joining another team will remove you from your current team. Do you want to continue?',confirm:'Continue',actionTone:'success',action:()=>joinKingTeam(team.id),cancelLabel:'Cancel',cancelTone:'danger'});
  }
