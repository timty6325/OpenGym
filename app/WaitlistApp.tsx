...
export default function App() {
  ...
  function askKingWinner(courtNumber:number){
    ...
    if(operator){
      setNotice({title:`Which team won on Court ${courtNumber}?`,message:'Select the team that won this game.',confirm:active[0].name,actionTone:'success',action:()=>recordKingWinner(courtNumber,active[0].id),cancelLabel:active[1].name,cancelTone:'success',cancelAction:()=>recordKingWinner(courtNumber,active[1].id),blocking:true});
      return;
    }
