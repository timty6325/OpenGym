...
export default function App() {
  ...
  function startTeamSubInvite(team:KingTeam){
    setNotice({title:'Invite a Sub',message:'Select one active player outside your team to invite as a sub. They must accept before becoming a substitute.',confirm:'Continue',actionTone:'success',cancelLabel:'Cancel',cancelTone:'danger',showBack:true,action:async()=>{setInviteSubTeamId(team.id)}});
  }
  ...
  return <Shell>
    ...
    <main className={`queue-page ${!admin&&me&&!meIsVisibleInQueue?'rejoin-only-queue':''}`}>
      ...
      {inviteSubTeamId&&<aside className="admin-group-toolbar team-sub-invite-toolbar"><span>Select one player outside your team</span><button className="group-cancel" onClick={()=>setInviteSubTeamId(null)}>Cancel</button></aside>}
