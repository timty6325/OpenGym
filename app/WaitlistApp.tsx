...
export default function App() {
  ...
  const ownKingCourt=ownKingTeam?.status==='current'?ownKingTeam.court_number:null;
...
const teamTutorialSteps=[
 ...
 {title:'Your team',message:'Your team is marked with a green border and a “Your team” label so you can quickly find yourself and your teammates.',target:'.own-king-team'},
 ...
 {title:'Current teams',message:'The two teams shown on each court are playing its current game. Only players on that court can advance it.',target:'.king-current-teams'},
 {title:'Team waitlist',message:'Waiting teams stay together in one shared line for all courts. Open spots can be filled with Join +.',target:'.king-waitlist'},
];
...
const teamHostTutorialSteps=[
 ...
 {title:'Move Players',message:'Press and hold a player on mobile, or drag them on desktop, to move them into any team with an open spot.',target:'.king-board'},
