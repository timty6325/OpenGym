...
export default function App() {
  ...
  const courtCountEditingRef=useRef(false);
  ...
  useEffect(()=>{if(!courtCountEditingRef.current)setCourtCountDraft(String(config.court_count))},[config.court_count]);
