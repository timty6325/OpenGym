...
export default function App() {
  ...
  return <Shell>
    ...
    <main className="queue-page">
      ...
      {config.mode==='teams'&&<KingBoard teams={kingTeams} courts={courts} me={me} admin={admin} host={host} busy={busy} nextGame={confirmTeamNext} joinTeam={confirmJoinKingTeam} joinEmptyTeam={confirmCreateKingTeam} setCourtRules={setTeamCourtRules} adminSitOut={confirmAdminSitOut} adminLeave={confirmAdminLeave} permissions={setPermissionPlayer}/>} 
